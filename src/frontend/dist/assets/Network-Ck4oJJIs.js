import { c as createLucideIcon, b as useSupplierProfiles, s as useSupplyNetworkGraph, r as reactExports, n as normalizeRisk, j as jsxRuntimeExports, S as Skeleton, R as RefreshCw, g as formatRiskScore, k as getRiskHex } from "./index-3OTCWF_L.js";
import { R as RiskBadge } from "./RiskBadge-00Mr7gXR.js";
import { B as Badge } from "./badge-TYyvX5gy.js";
import { B as Button, X } from "./button-C8pW3ns0.js";
import { S as Separator } from "./separator-wldK29C4.js";
...
function Network() {
  ...
  const handleTierFilter = reactExports.useCallback((t) => {
    setTierFilter(t);
    setSelectedNode(null);
    setTooltip(null);
  }, []);
  const networkNodes = reactExports.useMemo(() => {
    const backendNodes = (graphData == null ? void 0 : graphData.nodes) ?? [];
    if (backendNodes.length > 0) {
      return backendNodes.map((n) => {
        const tierNum = typeof n.tier === "number" ? n.tier : n.tier === "Tier1" || n.tier === 1 ? 1 : n.tier === "Tier2" || n.tier === 2 ? 2 : 3;
        return {
          supplierId: n.supplierId,
          supplierName: n.supplierName,
          tier: tierNum,
          category: typeof n.category === "string" ? n.category : Object.keys(n.category)[0] ?? "Unknown",
